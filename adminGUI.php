...
$baseURL = "https://www.uvm.edu/~jpsheeha/";
$folderPath = "cs148/assignment7.1/adminGUI/";
...
<form action="<? print $_SERVER['PHP_SELF']; ?>" method="post">
    <fieldset>
        ...
        <input name="txtGender" type="text" size="20" id="txtGender" <? print "value='$gender'"; ?>/><br>
				
				<label for="txtTrainerName"	>Trainer Name</label><br>
        <input name="txtTrainerName" type="text" size="20" id="txtTrainerName" <? print "value='$trainerName'"; ?>/><br>
