...
<nav>
	<ol>
<?php
if(basename($_SERVER['PHP_SELF'])=="http://www.uvm.edu/~jpsheeha/cs148/assignment7.1/loginHome.php"){
	print '<li class="activePage">Login</li>';
} else {
	print '<li><a href="http://www.uvm.edu/~jpsheeha/cs148/assignment7.1/loginHome.php">Login</a></li>';
}
